  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-espresso text-cream">
        ...
        <div className="relative mx-auto flex min-h-[82vh] max-w-7xl flex-col items-center justify-center px-4 py-24 text-center [text-shadow:0_2px_24px_rgba(0,0,0,0.5)]">
          <h1
